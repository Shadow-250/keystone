...
config.https = {
    ...
    cert_file: 'certs/idm-2020-cert.pem',
    key_file: 'certs/idm-2020-key.pem',
    ca_certs: [],
...
config.database = {
    ...
    password: "keystone", // default: 'idm'
    username: "keystone", // default: 'root'
    database: "keystone", // default: 'idm'
